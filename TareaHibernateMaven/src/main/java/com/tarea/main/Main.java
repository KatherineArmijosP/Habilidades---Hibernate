...
static SessionFactory sessionFactory = new MetadataSources( registry ).buildMetadata().buildSessionFactory();
	...
	public static void main(String[] args) {
		
		 {
			    ...
			    Persona persona1 = new Persona (0,"Bryan");
			    Persona persona2 = new Persona (0,"Katherine");
			    Persona persona3 = new Persona (0,"Rosado");
                ...
                Skill skill1 = new Skill (0,"Programar");
                Skill skill2 = new Skill (0,"Dibujar");
                Skill skill3 = new Skill (0,"Nadador");
                Skill skill4 = new Skill (0,"Pintor");
